...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	\vspace{0.75\baselineskip} % Whitespace above the title
        ...
        {\LARGE The Nummulosphere\\ Part 1\\ An Account of \\ the Organic Origin of\\ so-called Igneous Rocks\\ and of\\ Abyssal Red Clays \\} % Title
	...
	1$^{st}$ Edition, London 1913 % Publication year
...
\begin{figure}[b]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{Fig-1.png} Figure 1
\end{figure}
\clearpage
\end{document}
