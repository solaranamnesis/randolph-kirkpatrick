...
The experiments of R. Liesegang ("Geologische Diffusionen") on precipitation, show the order of deposition of the "rhythmical precipitations" to be from periphery to centre. If, as is probable, the same law holds for _Eozoön_ the fine outer bands of ferromagnesian silicates would be thrown down first. 
